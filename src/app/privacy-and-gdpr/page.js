    ...
    <main className="pt-20 sm:pt-28 md:pt-32 pb-16 sm:pb-24 px-4 sm:px-6 max-w-3xl mx-auto">
      ...
      <div className="space-y-6 text-secondary leading-relaxed">
        <section>
          ...
          <p>{p.sec_1_desc}<br />Contact: <a href="mailto:contact@qubital.eu" className="text-primary hover:underline">contact@qubital.eu</a></p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>{p.sec_3_desc} <a href="mailto:contact@qubital.eu" className="text-primary hover:underline">contact@qubital.eu</a>.</p>
        </section>
        <section>
