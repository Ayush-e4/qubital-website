...
const dictionary = {
  ...
  contact_page: {
    ...
    subtitle:
      'Contacte con nuestro equipo principal de ingeniería para discutir sus necesidades arquitectónicas.',
  ...
  about_page: {
    ...
    hero_desc:
      'Aportamos claridad a las arquitecturas distribuidas, proporcionando a los líderes tecnológicos la visión estratégica necesaria para escalar sin fricciones.',
    ...
    origins_desc:
      'Fundada por exdirectores de ingeniería en Herzogenaurach, Qubital conecta la estrategia IT con la implementación técnica.',
    story_p1:
    ...
    cta_desc:
      'Inicie una evaluación confidencial de su infraestructura actual para identificar cuellos de botella.',
  ...
  services_page: {
    ...
    hero_desc:
      'Transformando la complejidad técnica en simplicidad operativa. Ofrecemos ingeniería estructurada y supervisión estratégica.',
    hero_cta: 'Contratar Servicios',
    matrix_tag: 'MATRIZ DE PRÁCTICAS',
    matrix_title: 'Disciplinas de Competencia Estructuradas',
    matrix_desc:
      'Nuestras áreas principales combinan estándares fiables con alineación estratégica.',
    matrix_cards: [
      {
        tag: 'DEV',
        icon: 'terminal',
        ...
        description:
          'Aplicaciones web y herramientas a medida para optimizar los flujos de trabajo de su empresa.',
        items: [
      ...
      },
      {
        ...
        description:
          'Atención proactiva, monitorización continua y soporte rápido para que su negocio no se detenga.',
      ...
      },
      {
        ...
        description:
          'Configuración y migración cloud confiables para mantener sus datos seguros y eficientes.',
        items: [
      ...
      },
      {
        ...
        description:
          'Estándares de seguridad sencillos y efectivos para proteger los datos y dispositivos de su empresa.',
      ...
      },
      {
        ...
        description:
          'Herramientas inteligentes y automatizaciones que eliminan tareas repetitivas.',
      ...
      },
      {
        ...
        description:
          'Migraciones S/4HANA empresariales, estrategia clean-core e integraciones SAP BTP diseñadas para escalabilidad.',
        items: [
    ...
    methodology_desc:
      'Nuestro ciclo de cuatro fases garantiza transparencia, reducción de riesgos y resultados previsibles.',
  ...
  careers_page: {
    ...
    hero_desc:
      'Invitamos a ingenieros y arquitectos a unirse a nosotros para desarrollar soluciones sólidas e inteligentes.',
    ...
    network_desc:
      'Siempre estamos abiertos a conocer talento excepcional mediante candidaturas espontáneas.',
  ...
  impressum_page: {
    ...
    sec_3_desc:
      'Conforme al § 55 Abs. 2 RStV: Qubital Systems GmbH, Herzogenaurach, Baviera, Alemania.',
  ...
  privacy_page: {
    ...
    intro:
      'Qubital Systems GmbH se compromete a la protección de datos personales conforme al RGPD.',
  ...
  mission_page: {
    ...
    quote_text:
      'La verdadera claridad arquitectónica no consiste en añadir más abstracciones, sino en tener la convicción de aislar límites, eliminar dependencias y construir sistemas soberanos duraderos.',
